...
const initialTrustedCompanies: TrustedCompany[] = [
    { id: 'tc_1', name: 'Microsoft', url: 'https://microsoft.com', status: 'Active' },
    { id: 'tc_2', name: 'Google', url: 'https://google.com', status: 'Active' },
    { id: 'tc_3', name: 'Amazon', url: 'https://amazon.com', status: 'Active' },
    { id: 'tc_4', name: 'Meta', url: 'https://meta.com', status: 'Active' },
    { id: 'tc_5', name: 'Apple', url: 'https://apple.com', status: 'Active' },
    { id: 'tc_6', name: 'Tesla', url: 'https://tesla.com', status: 'Active' },
    { id: 'tc_7', name: 'Netflix', url: 'https://netflix.com', status: 'Active' },
    { id: 'tc_8', name: 'Spotify', url: 'https://spotify.com', status: 'Active' },
    { id: 'tc_9', name: 'Adobe', url: 'https://adobe.com', status: 'Active' },
    { id: 'tc_10', name: 'Salesforce', url: 'https://salesforce.com', status: 'Active' },
    { id: 'tc_11', name: 'Oracle', url: 'https://oracle.com', status: 'Active' },
    { id: 'tc_12', name: 'IBM', url: 'https://ibm.com', status: 'Active' },
    { id: 'tc_13', name: 'Intel', url: 'https://intel.com', status: 'Active' },
    { id: 'tc_14', name: 'NVIDIA', url: 'https://nvidia.com', status: 'Active' },
    { id: 'tc_15', name: 'Samsung', url: 'https://samsung.com', status: 'Active' },
    { id: 'tc_16', name: 'Sony', url: 'https://sony.com', status: 'Active' },
    { id: 'tc_17', name: 'Uber', url: 'https://uber.com', status: 'Active' },
    { id: 'tc_18', name: 'Airbnb', url: 'https://airbnb.com', status: 'Active' },
    { id: 'tc_19', name: 'PayPal', url: 'https://paypal.com', status: 'Active' },
    { id: 'tc_20', name: 'Shopify', url: 'https://shopify.com', status: 'Active' },
    { id: 'tc_21', name: 'Zoom', url: 'https://zoom.us', status: 'Active' },
    { id: 'tc_22', name: 'Slack', url: 'https://slack.com', status: 'Active' },
    { id: 'tc_23', name: 'Dropbox', url: 'https://dropbox.com', status: 'Active' },
    { id: 'tc_24', name: 'Twitter', url: 'https://twitter.com', status: 'Active' },
    { id: 'tc_25', name: 'LinkedIn', url: 'https://linkedin.com', status: 'Active' },
    { id: 'tc_26', name: 'TikTok', url: 'https://tiktok.com', status: 'Active' },
    { id: 'tc_27', name: 'Instagram', url: 'https://instagram.com', status: 'Active' },
    { id: 'tc_28', name: 'WhatsApp', url: 'https://whatsapp.com', status: 'Active' },
    { id: 'tc_29', name: 'YouTube', url: 'https://youtube.com', status: 'Active' },
    { id: 'tc_30', name: 'Discord', url: 'https://discord.com', status: 'Active' },
];
