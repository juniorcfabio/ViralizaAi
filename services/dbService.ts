...
const initialTrustedCompanies: TrustedCompany[] = [
    { id: 'tc_1', name: 'Microsoft', url: 'https://microsoft.com', status: 'Active', logo: 'https://img.icons8.com/color/96/microsoft.png' },
    { id: 'tc_2', name: 'Google', url: 'https://google.com', status: 'Active', logo: 'https://img.icons8.com/color/96/google-logo.png' },
    { id: 'tc_3', name: 'Amazon', url: 'https://amazon.com', status: 'Active', logo: 'https://img.icons8.com/color/96/amazon.png' },
    { id: 'tc_4', name: 'Meta', url: 'https://meta.com', status: 'Active', logo: 'https://img.icons8.com/color/96/meta.png' },
    { id: 'tc_5', name: 'Apple', url: 'https://apple.com', status: 'Active', logo: 'https://img.icons8.com/ios-filled/96/mac-os.png' },
    { id: 'tc_6', name: 'Tesla', url: 'https://tesla.com', status: 'Active', logo: 'https://img.icons8.com/color/96/tesla.png' },
    { id: 'tc_7', name: 'Netflix', url: 'https://netflix.com', status: 'Active', logo: 'https://img.icons8.com/color/96/netflix.png' },
    { id: 'tc_8', name: 'Spotify', url: 'https://spotify.com', status: 'Active', logo: 'https://img.icons8.com/color/96/spotify.png' },
    { id: 'tc_9', name: 'Adobe', url: 'https://adobe.com', status: 'Active', logo: 'https://img.icons8.com/color/96/adobe-creative-cloud.png' },
    { id: 'tc_10', name: 'Salesforce', url: 'https://salesforce.com', status: 'Active', logo: 'https://img.icons8.com/color/96/salesforce.png' },
    { id: 'tc_11', name: 'Oracle', url: 'https://oracle.com', status: 'Active', logo: 'https://img.icons8.com/color/96/oracle-logo.png' },
    { id: 'tc_12', name: 'IBM', url: 'https://ibm.com', status: 'Active', logo: 'https://img.icons8.com/color/96/ibm.png' },
    { id: 'tc_13', name: 'Intel', url: 'https://intel.com', status: 'Active', logo: 'https://img.icons8.com/color/96/intel.png' },
    { id: 'tc_14', name: 'NVIDIA', url: 'https://nvidia.com', status: 'Active', logo: 'https://img.icons8.com/color/96/nvidia.png' },
    { id: 'tc_15', name: 'Samsung', url: 'https://samsung.com', status: 'Active', logo: 'https://img.icons8.com/color/96/samsung.png' },
    { id: 'tc_16', name: 'Sony', url: 'https://sony.com', status: 'Active', logo: 'https://img.icons8.com/color/96/sony.png' },
    { id: 'tc_17', name: 'Uber', url: 'https://uber.com', status: 'Active', logo: 'https://img.icons8.com/color/96/uber.png' },
    { id: 'tc_18', name: 'Airbnb', url: 'https://airbnb.com', status: 'Active', logo: 'https://img.icons8.com/color/96/airbnb.png' },
    { id: 'tc_19', name: 'PayPal', url: 'https://paypal.com', status: 'Active', logo: 'https://img.icons8.com/color/96/paypal.png' },
    { id: 'tc_20', name: 'Shopify', url: 'https://shopify.com', status: 'Active', logo: 'https://img.icons8.com/color/96/shopify.png' },
    { id: 'tc_21', name: 'Zoom', url: 'https://zoom.us', status: 'Active', logo: 'https://img.icons8.com/color/96/zoom.png' },
    { id: 'tc_22', name: 'Slack', url: 'https://slack.com', status: 'Active', logo: 'https://img.icons8.com/color/96/slack-new.png' },
    { id: 'tc_23', name: 'Dropbox', url: 'https://dropbox.com', status: 'Active', logo: 'https://img.icons8.com/color/96/dropbox.png' },
    { id: 'tc_24', name: 'Twitter', url: 'https://twitter.com', status: 'Active', logo: 'https://img.icons8.com/color/96/twitter.png' },
    { id: 'tc_25', name: 'LinkedIn', url: 'https://linkedin.com', status: 'Active', logo: 'https://img.icons8.com/color/96/linkedin.png' },
    { id: 'tc_26', name: 'TikTok', url: 'https://tiktok.com', status: 'Active', logo: 'https://img.icons8.com/color/96/tiktok.png' },
    { id: 'tc_27', name: 'Instagram', url: 'https://instagram.com', status: 'Active', logo: 'https://img.icons8.com/color/96/instagram-new.png' },
    { id: 'tc_28', name: 'WhatsApp', url: 'https://whatsapp.com', status: 'Active', logo: 'https://img.icons8.com/color/96/whatsapp.png' },
    { id: 'tc_29', name: 'YouTube', url: 'https://youtube.com', status: 'Active', logo: 'https://img.icons8.com/color/96/youtube-play.png' },
    { id: 'tc_30', name: 'Discord', url: 'https://discord.com', status: 'Active', logo: 'https://img.icons8.com/color/96/discord-logo.png' },
];
