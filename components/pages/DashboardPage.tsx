...
import { generateSalesFunnel, generateGrowthCampaign, analyzeViralTrends, optimizeBio, generateEditorialCalendar, generateHashtagSuggestions, predictViralPotential } from '../../services/geminiService';
import { SalesFunnel, GrowthCampaign, PostIdea, LocationConfig, ViralTrend, BioOptimization, EditorialDay, HashtagSuggestion, ViralPredictionResult } from '../../types';
...
const FilterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>;
...
const DownloadIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>;
const TrendingUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline><polyline points="17 6 23 6 23 12"></polyline></svg>;
const CalendarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>;
const UserCheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><polyline points="16 11 18 13 22 9"/></svg>;
const HashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="9" x2="20" y2="9"/><line x1="4" y1="15" x2="20" y2="15"/><line x1="10" y1="3" x2="8" y2="21"/><line x1="16" y1="3" x2="14" y2="21"/></svg>;
...
const BrainIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z"/><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z"/></svg>;
const LockIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>;
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700">
                <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
                    ...
                    <div className="flex gap-2">
                        <button onClick={handleDownload} className="bg-primary border border-gray-600 text-white px-4 py-2 rounded-full text-sm font-bold hover:bg-gray-700 flex items-center gap-2">
                            <DownloadIcon className="w-4 h-4" /> Baixar Arquivo (Offline)
                        </button>
                        <button onClick={handlePrintPdf} className="bg-green-600 text-white px-4 py-2 rounded-full text-sm font-bold hover:bg-green-500 flex items-center gap-2">
                                ...
                                {funnel.leadMagnet.chapters?.map((chapter, idx) => (
                                    <div key={idx} className="mb-4 border-b border-gray-700 pb-4 last:border-0">
                                        <div className="flex items-start gap-3">
                                            {chapter.image && <img src={chapter.image} alt={`Chapter ${idx+1}`} className="w-16 h-16 rounded object-cover bg-gray-800"/>}
                                            <div>
                                                <p className="font-bold text-light">{idx + 1}. {chapter.title}</p>
                                                <p className="text-sm text-gray-400 mt-1 whitespace-pre-line line-clamp-3">{chapter.content}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <button className="bg-accent text-white px-6 py-3 rounded-full mt-2 font-bold pointer-events-none">{funnel.landingPageCopy.cta}</button>
                    </div>
                </div>
            </div>
...
const AdvancedGrowthTools: React.FC<{ businessInfo: string, checkAccess: () => boolean }> = ({ businessInfo, checkAccess }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mt-8">
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700 flex flex-col">
                ...
                <p className="text-sm text-gray-400 mb-4 flex-1">Descubra o que está viralizando no seu nicho agora.</p>
                <button 
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700 flex flex-col">
                ...
                <p className="text-sm text-gray-400 mb-4 flex-1">Transforme visitantes em seguidores com uma bio magnética.</p>
                 <button 
                ...
                {bio && (
                    <div className="bg-primary p-3 rounded text-sm space-y-2">
                        <p><strong>Nome:</strong> {bio.headline}</p>
                        <p><strong>Bio:</strong> {bio.body}</p>
                        <p><strong>CTA:</strong> {bio.cta}</p>
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700 flex flex-col">
                ...
                <p className="text-sm text-gray-400 mb-4 flex-1">Planejamento de 7 dias para constância máxima.</p>
                <button 
            ...
            <div className="bg-secondary p-6 rounded-lg border border-gray-700 flex flex-col">
                ...
                <p className="text-sm text-gray-400 mb-4 flex-1">Grupos de tags otimizados para alcance máximo.</p>
                <button 
...
const ViralPredictionTool: React.FC<{ checkAccess: () => boolean }> = ({ checkAccess }) => {
    ...
    const handlePurchase = async () => {
        ...
        if (window.confirm('Comprar o Add-on "Motor de Previsão Viral" por R$ 99,90?')) {
            setPurchasing(true);
            const success = await purchaseAddOn(user.id, 'viralPrediction', 99.90);
            setPurchasing(false);
            if (success) {
                ...
                {isLocked && (
                    <div className="absolute inset-0 bg-secondary/95 z-20 flex flex-col items-center justify-center text-center p-8 backdrop-blur-sm">
                        ...
                        <p className="text-gray-400 mb-6 max-w-md">
                            O Motor de Previsão Viral está disponível exclusivamente no <strong>Plano Anual</strong> ou como compra avulsa.
                        </p>
                        <div className="flex flex-col gap-3 w-full max-w-xs">
                            ...
                            <div className="flex items-center gap-2 justify-center text-xs text-gray-500 uppercase font-bold">OU</div>
                            <button 
            ...
            <div className="bg-secondary p-8 rounded-lg border border-gray-700 flex flex-col justify-center items-center text-center min-h-[400px]">
                {!result ? (
                    ...
                    <div className="w-full animate-fade-in-up">
                        ...
                        <h4 className="text-2xl font-bold mb-2 text-light">Probabilidade: <span className={getScoreColor(result.score)}>{result.viralProbability}</span></h4>
...
const DashboardPage: React.FC = () => {
    ...
    const handleAddComment = (text: string) => {
        ...
        const updatedPost = {
            ...selectedPost,
            comments: [...(selectedPost.comments || []), { id: Date.now(), author: user?.name || 'Eu', text, avatar: user?.avatar || 'https://via.placeholder.com/40' }]
        };
    ...
    return (
        <div className="space-y-8">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h2 className="text-3xl font-bold">Dashboard de Crescimento</h2>
            ...
            <section className="bg-secondary p-6 rounded-lg border border-gray-800 relative">
                <h3 className="text-xl font-bold mb-4">Sobre o seu Negócio</h3>
                <textarea
                    value={businessInfo}
                    onChange={handleBusinessInfoChange}
                    readOnly={!hasActiveSubscription}
                    onClick={() => !hasActiveSubscription && setShowPaywall(true)}
                    placeholder="Descreva seu negócio, produto e público-alvo. Ex: Loja de roupas femininas focada em moda sustentável para mulheres de 25-35 anos."
                    className={`w-full bg-primary p-4 rounded-lg border border-gray-700 focus:border-accent focus:ring-1 focus:ring-accent h-24 resize-none ${!hasActiveSubscription ? 'cursor-not-allowed opacity-70' : ''}`}
                />
                <div className="flex flex-wrap gap-4 mt-4">
                    <div className="flex-1 min-w-[150px]">
                        ...
                        <select 
                            ...
                            className="w-full bg-primary p-2 rounded border border-gray-700 disabled:opacity-50"
                        >
                            <option>Instagram</option>
                            <option>TikTok</option>
                            <option>LinkedIn</option>
                ...
                {!hasActiveSubscription && (
                    <div className="absolute inset-0 z-10 cursor-pointer" onClick={() => setShowPaywall(true)}></div>
                )}
            </section>
            ...
            <div className="border-b border-gray-700">
                <nav className="-mb-px flex space-x-8 overflow-x-auto">
                    ...
                    >
                        <span className="flex items-center gap-1"><BrainIcon className="w-4 h-4"/> Previsão Viral (IA)</span>
                    </button>
                </nav>
            </div>
            ...
            {activeTab === 'growth' && (
                <div className="animate-fade-in-right">
                    <button 
                        ...
                        className={`w-full bg-accent text-light font-semibold py-3 rounded-full hover:bg-blue-500 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] ${!hasActiveSubscription ? 'opacity-70' : ''}`}
                    >
                        <RocketIcon className="w-5 h-5"/> {isGeneratingGrowth ? 'Gerando Estratégia...' : 'Gerar Campanha de Crescimento'}
                    </button>
                        ...
                        <div className="mt-8 space-y-6 animate-fade-in-up">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {growthCampaign.posts.map((post) => (
                                    <div key={post.id} className="bg-secondary p-6 rounded-lg border border-gray-700 hover:border-accent transition-colors group">
                                        <div className="flex justify-between items-start mb-4">
                                            <span className="text-xs font-bold bg-primary px-2 py-1 rounded uppercase text-gray-400">{post.platform}</span>
                                            <button onClick={() => openCommentModal(post)} className="text-gray-400 hover:text-light p-1 rounded hover:bg-primary">
                                                <MessageSquareIcon className="w-5 h-5" />
                                            </button>
                                        </div>
                                        <h4 className="font-bold text-lg mb-2 group-hover:text-accent transition-colors">{post.title}</h4>
            ...
            {activeTab === 'funnel' && (
                <div className="animate-fade-in-right">
                     <button onClick={handleGenerateFunnel} className={`w-full bg-accent text-light font-semibold py-3 rounded-full hover:bg-blue-500 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] ${!hasActiveSubscription ? 'opacity-70' : ''}`}>
                        <FilterIcon className="w-5 h-5"/> {isGeneratingFunnel ? 'Escrevendo Ebook Premium (15 Pág) e criando imagens...' : 'Gerar Ebook Premium (15 Páginas + Fotos)'}
                    </button>
                    {isGeneratingFunnel && (
                        <div className="mt-4 text-center animate-pulse bg-blue-900/20 p-4 rounded-lg">
                            ...
                            <p className="text-sm text-gray-400 mt-1">Estamos escrevendo 12 capítulos detalhados e gerando ilustrações exclusivas para cada um. Isso pode levar cerca de 40-60 segundos. Por favor, aguarde.</p>
                        </div>
                    )}
                    {salesFunnel ? <SalesFunnelBlueprint funnel={salesFunnel} /> : !isGeneratingFunnel && <p className="text-center text-gray-dark mt-8">Preencha a descrição para gerar seu funil de alta conversão.</p>}
                </div>
            )}
            ...
            {activeTab === 'advanced' && (
                <div className="animate-fade-in-right">
                    ...
                    {businessInfo ? (
                        ...
                        <p className="text-center text-red-400 mt-8">Por favor, preencha a descrição do seu negócio acima para usar estas ferramentas.</p>
                    )}
                </div>
            )}
